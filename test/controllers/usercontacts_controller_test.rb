...
class UsercontactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usercontact" do
    assert_difference('Usercontact.count') do
      post usercontacts_url, params: { usercontact: { email: @usercontact.email, login: @usercontact.login, name: @usercontact.name } }
    end
  ...
  test "should update usercontact" do
    patch usercontact_url(@usercontact), params: { usercontact: { email: @usercontact.email, login: @usercontact.login, name: @usercontact.name } }
